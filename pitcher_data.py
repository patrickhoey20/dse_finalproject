...
# Print header
print('link' + ',' + 'hall_of_fame' + ',' + 'active_player' + ',' + 'years_played' + ',' + 'career_era' + ',' + 'career_whip' + ',' + 'career_ip' + ',' + 'career_wl' + ',' + 'career_wins' + ',' + 'career_ko9' + ',' + 'career_war' + ',' + 'career_saves' + ',' + 'world_series_wins' + ',' + 'cy_young_awards' + ',' + 'mvps' + ',' + 'era_titles' + ',' + 'all_star_apps')
...
for link in linklist:
    ...
    for elem in z:
        if elem.text == 'ERA':
            ...
            career_ko9 = 0
            x = soup.body.tfoot.tr
            x = x.find('td',{'data-stat':'strikeouts_per_nine'})
            if not x == None:
                career_ko9 = x.text
            else:
                career_ko9 = ''
            # CAREER WAR (not working)
            career_war = 0
            x = soup.body
            z = x.find('td',{'data-stat':'WAR_pitch'})
            if not z == None:
                career_war = z.text
            else:
                career_war = ''
            ...
            # INSERT ALL DATA
            print(link + ',' + str(hall_of_fame) + ',' + str(active_player) + ',' + str(years_played) + ',' + str(career_era) + ',' + str(career_whip) + ',' + str(career_ip) + ',' + str(career_wl) + ',' + str(career_wins) + ',' + str(career_ko9) + ',' + str(career_war) + ',' + str(career_saves) + ',' + str(world_series_wins) + ',' + str(cy_young_awards) + ',' + str(mvps) + ',' + str(era_titles) + ',' + str(all_star_apps))
